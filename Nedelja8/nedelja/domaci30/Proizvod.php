<?php 
    ...
    class Proizvod{
        public $id, $ime,$slika,$opis,$naslov, $cena;
        public $grupa;
...
class WebSite{
    ...
    function header(){
        echo "<h1>Dobro dosli u web-sop </h1><br><a href='index.php'> Pocetna</a>";
    }
    function footer(){
    ...
    function meni(){
        ...
        <a href="index.php?grupa=prva">mlecne</a><br/>
        <a href="index.php?grupa=druga">crne</a><br/>
        <a href="index.php?grupa=treca"> s vocem</a><br/>
